...
public class Main {
	...
	public static void main(String[] args) {
		...
		Pais serbia = new Pais ("Serbia", 0, true, "G", 0, "SER", 26, 0, 0);
		Pais suiza = new Pais ("Suiza", 0, true, "G", 0, "SUI", 27, 0, 0);
		Pais camerun = new Pais ("Camerun", 0, true, "G", 0, "CAM", 28, 0, 0);
		
		Pais portugal = new Pais ("Portugal", 0, true, "H", 0, "POR", 29, 0, 0);
		Pais ghana = new Pais ("Ghana", 0, true, "H", 0, "GHA", 30, 0, 0);
		Pais uruguay = new Pais ("Uruguay", 0, true, "H", 0, "URU", 31, 0, 0);
		Pais corea = new Pais ("Corea del Sur", 0, true, "H", 0, "COR", 32, 0, 0);
		...
		Menu(paises, octavos, cuartos, semi, finall, partidos);
		}
	
		
		public static void Menu(LinkedList<Pais> paises, LinkedList<Pais> octavos, LinkedList<Pais> cuartos, LinkedList<Pais> semi, LinkedList<Pais> finall, LinkedList<Partido> partidos) { 
		...
		public static void rec (LinkedList<Pais> grupos, Pais pais) {
		...
		public static void PosicionesGrupo(LinkedList<Pais> grupos) {
			...
			for (Pais pais : grupos) {
				if (pais.getGrupo().equalsIgnoreCase(g)) {
					...
					System.out.println( pais.getAb() + "\t" + pais.getPuntos() + "\t" + pais.getGf() + "\t" + pais.getGc() );
				}
			}
